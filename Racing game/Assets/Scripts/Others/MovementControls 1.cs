// GENERATED AUTOMATICALLY FROM 'Assets/Scripts/Others/MovementControls 1.inputactions'
...
public class @MovementControls1 : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @MovementControls1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""MovementControls 1"",
    ""maps"": [
        {
            ""name"": ""Movement"",
    ...
    {
        private @MovementControls1 m_Wrapper;
        public MovementActions(@MovementControls1 wrapper) { m_Wrapper = wrapper; }
